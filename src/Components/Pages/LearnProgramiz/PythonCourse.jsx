...
const PythonCourse = () => {
  ...
  return (
    ...
    <div>
      ...
      <div className="container my-5">
        <div className="row justify-content-center">
          <div className="col-lg-8">
            <div className="p-4 bg-peach rounded shadow d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center text-center text-lg-start">
              <div>
                <div className="d-flex justify-content-center justify-content-lg-start align-items-center mb-2">
                  <h5 className="mb-0 text-primary fw-bold">Programiz</h5>
                  <span className="badge bg-purple ms-2">PRO</span>
                </div>
      ...
      {/* --- {courseName} Course Topics Accordion Section --- */}
      <div className="container my-5">
